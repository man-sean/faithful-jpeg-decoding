...
class FirstMomentLoss(nn.Module):
    ...
    def __init__(self, loss_weight=1.0, reduction='mean', batch_size=4, expansion=16, iters=1):
        super(FirstMomentLoss, self).__init__()
    ...
    def forward(self, pred, target, weight=None, **kwargs):
        ...
        """
        return self.loss_weight * self.loss(pred, target[:self.batch_size], weight, reduction=self.reduction)
